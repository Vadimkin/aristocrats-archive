  ...
  return (
    <div class="page">
      ...
      <div class="wrap settings">
        ...
        <h1>Налаштування</h1>
      <p class="note">
        Ми зберігаємо стан та історію прослуховувань, щоб можна було в будь-який час повернутись до подкасту. Ці дані зберігаються в браузері та нікуди не надсилаються. Якщо потрібно перенести на інший девайс – скористайтесь експортом.
      </p>
